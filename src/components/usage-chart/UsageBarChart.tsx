      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis 
            ...
            stroke="#666"
            tick={{ fill: '#999' }} 
            // Обновленные параметры для отображения тиков на оси X
            interval={Math.ceil(data.length / 15) - 1} // Динамический расчет интервала для ~15 тиков
          ...
          <Bar 
            ...
            name="Запросы"
            // Уменьшаем максимальную ширину столбика
            maxBarSize={15}
          />
        </BarChart>
      </ResponsiveContainer>
